  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center">
        <div
          className="w-20 h-20 rounded-full border-4 border-yellow-300 flex items-center justify-center shadow-xl bg-black/50 backdrop-blur-sm text-white text-2xl"
          style={{ transform: `rotate(${direction}deg)` }}
        >
          🧭
        </div>
        <div className="mt-1 text-white font-bold">{direction}°</div>
      </div>
